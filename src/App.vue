<template>
  <v-app :theme="dark ? 'dark' : 'light'">
    <!-- <v-main>
      <tg-main>
        <template #main><suspense><tg-main-page v-if="currentPage=='main'"></tg-main-page></suspense><tg-chat-page v-if="currentPage=='chat'"></tg-chat-page><tg-settings-page v-if="currentPage=='settings'"></tg-settings-page><suspense><tg-contacts-page v-if="currentPage=='contacts'"></tg-contacts-page></suspense></template>
